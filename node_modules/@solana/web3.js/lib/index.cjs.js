...
function () {
  ...
  _createClass(Transaction, [{
    ...
    value: function _getSignData() {
      ...
      var signDataLayout = BufferLayout.struct([BufferLayout.blob(1, 'numRequiredSignatures'), BufferLayout.blob(1, 'numReadonlySignedAccounts'), BufferLayout.blob(1, 'numReadonlyUnsignedAccounts'), BufferLayout.blob(keyCount.length, 'keyCount'), BufferLayout.seq(publicKey('key'), keys.length, 'keys'), publicKey('recentBlockhash')]);
      var transaction = {
...
var NonceAccountLayout = BufferLayout.struct([BufferLayout.u32('state'), publicKey('authorizedPubkey'), publicKey('nonce')]);
/**
 * NonceAccount class
 */
 ...
 */
var GetInflationResult = superstruct.struct({
  foundation: 'number',
...
var SignatureStatusResult = superstruct.struct.union([superstruct.struct({
  Ok: 'null'
}), superstruct.struct({
  Err: 'object'
})]);
...
var Version = superstruct.struct({
  'solana-core': 'string'
});
/**
...
var GetInflationRpcResult = superstruct.struct({
...
var SlotInfo = superstruct.struct({
  parent: 'number',
  slot: 'number',
  root: 'number'
});
...
var GetClusterNodes = jsonRpcResult(superstruct.struct.array([superstruct.struct({
  pubkey: 'string',
  gossip: 'string',
...
var GetVoteAccounts = jsonRpcResult(superstruct.struct({
  current: superstruct.struct.array([superstruct.struct({
    votePubkey: 'string',
    nodePubkey: 'string',
  ...
  delinquent: superstruct.struct.array([superstruct.struct({
    votePubkey: 'string',
    nodePubkey: 'string',
    activatedStake: 'number',
    epochVoteAccount: 'boolean',
...
var GetSignatureStatusRpcResult = jsonRpcResult(superstruct.struct.union(['null', SignatureStatusResult]));
/**
...
var GetConfirmedBlockRpcResult = jsonRpcResult(superstruct.struct.union(['null', superstruct.struct({
  blockhash: 'string',
  previousBlockhash: 'string',
  parentSlot: 'number',
  transactions: superstruct.struct.array([superstruct.struct({
    transaction: superstruct.struct({
      ...
      message: superstruct.struct({
        ...
        instructions: superstruct.struct.array([superstruct.struct.union([superstruct.struct.array(['number']), superstruct.struct({
    ...
    meta: superstruct.struct.union(['null', superstruct.struct({
      status: superstruct.struct.union(['null', SignatureStatusResult]),
      fee: 'number',
...
function () {
  ...
  function Connection(endpoint, commitment) {
    ...
    this._rpcRequest = createRpcRequest(url$1.href);
  ...
  _createClass(Connection, [{
    ...
    value: function () {
      var _getBalanceAndContext = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee2(publicKey, commitment) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee3(publicKey, commitment) {
    ...
    value: function () {
      var _getAccountInfoAndContext = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee4(publicKey, commitment) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee5(publicKey, commitment) {
    ...
    value: function () {
      var _getProgramAccounts = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee6(programId, commitment) {
    ...
    value: function () {
      var _confirmTransactionAndContext = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee7(signature, commitment) {
        var args, unsafeRes, res;
    ...
    value: function () {
      var _confirmTransaction = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee8(signature, commitment) {
    ...
    key: "getClusterNodes",
    value: function () {
      var _getClusterNodes = _asyncToGenerator(
      /*#__PURE__*/
    ...
    key: "getVoteAccounts",
    value: function () {
      var _getVoteAccounts = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee10(commitment) {
        var args, unsafeRes, res;
    ...
    key: "getSlot",
    value: function () {
      var _getSlot = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee11(commitment) {
        var args, unsafeRes, res;
    ...
    key: "getSlotLeader",
    value: function () {
      var _getSlotLeader = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee12(commitment) {
        var args, unsafeRes, res;
    ...
    value: function () {
      var _getSignatureStatus = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee13(signature, commitment) {
        var args, unsafeRes, res;
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee14(commitment) {
        var args, unsafeRes, res;
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee15(commitment) {
        var args, unsafeRes, res;
    ...
    key: "getInflation",
    value: function () {
      var _getInflation = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee16(commitment) {
        var args, unsafeRes, res;
    ...
    key: "getEpochInfo",
    value: function () {
      var _getEpochInfo = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee17(commitment) {
        var args, unsafeRes, res;
    ...
    value: function () {
      var _getEpochSchedule = _asyncToGenerator(
      /*#__PURE__*/
    ...
    value: function () {
      var _getMinimumBalanceForRentExemption = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee19(dataLength, commitment) {
        var args, unsafeRes, res;
    ...
    value: function () {
      var _getRecentBlockhashAndContext = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee20(commitment) {
        var args, unsafeRes, res;
    ...
    value: function () {
      var _getRecentBlockhash = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee21(commitment) {
    ...
    value: function () {
      var _getConfirmedBlock = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee23(slot) {
    ...
    value: function () {
      var _getNonceAndContext = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee24(nonceAccount, commitment) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee25(nonceAccount, commitment) {
    ...
    key: "requestAirdrop",
    value: function () {
      var _requestAirdrop = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee26(to, amount, commitment) {
        var args, unsafeRes, res;
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee27(transaction) {
        var _len,
            signers,
            _key,
            seconds,
    ...
    key: "validatorExit",
    value: function () {
      var _validatorExit = _asyncToGenerator(
      /*#__PURE__*/
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee29(rawTransaction) {
    ...
    value: function () {
      var _sendEncodedTransaction = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee30(encodedTransaction) {
        var unsafeRes, res;
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee31(sub, rpcMethod, rpcArgs) {
        var id;
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee32(sub, rpcMethod) {
    ...
    value: function () {
      var _removeAccountChangeListener = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee33(id) {
        var subInfo;
    ...
    value: function () {
      var _removeProgramAccountChangeListener = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee34(id) {
        var subInfo;
    ...
    value: function () {
      var _removeSlotChangeListener = _asyncToGenerator(
      /*#__PURE__*/
    ...
    value: function () {
      var _removeSignatureListener = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee36(id) {
        var subInfo;
...
function _sendAndConfirmRecentTransaction() {
  _sendAndConfirmRecentTransaction = _asyncToGenerator(
  /*#__PURE__*/
...
function _sendAndConfirmTransaction2() {
  _sendAndConfirmTransaction2 = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime.mark(function _callee2(connection, transaction) {
    var _len2,
        signers,
        _key2,
        _args2 = arguments;
...
function _sendAndConfirmTransaction3() {
  _sendAndConfirmTransaction3 = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime.mark(function _callee3(connection, transaction, signers, commitment) {
...
/*#__PURE__*/
function (_TransactionInstructi) {
...
function () {
  ...
  _createClass(Loader, null, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee(connection, payer, program, programId, data) {
        var balanceNeeded, transaction, dataLayout, chunkSize, offset, array, transactions, bytes, _data, _transaction, _dataLayout, _data2, _transaction2;
...
function _sendAndConfirmRawTransaction() {
  _sendAndConfirmRawTransaction = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime.mark(function _callee(connection, rawTransaction, commitment) {
...
exports.StakeInstructionLayout = StakeInstructionLayout;
...
exports.sendAndConfirmRecentTransaction = sendAndConfirmRecentTransaction;
