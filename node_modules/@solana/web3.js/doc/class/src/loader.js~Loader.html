...
<head>
  ...
  <title data-ice="title">Loader | Solana Javascript API</title>
...
<div class="content" data-ice="content"><div class="header-notice">
  <div data-ice="importPath" class="import-path"><pre class="prettyprint"><code data-ice="importPathCode">import {Loader} from &apos;<span><a href="file/src/loader.js.html#lineNumber18">@solana/web3</a></span>&apos;</code></pre></div>
  <span data-ice="access">public</span>
  <span data-ice="kind">class</span>
  
  
  
  <span data-ice="source">| <span><a href="file/src/loader.js.html#lineNumber18">source</a></span></span>
</div>

<div class="self-detail detail">
  <h1 data-ice="name">Loader</h1>
  ...
  <div class="description" data-ice="description"><p>Program loader interface</p>
</div>
    ...
    <td>
      <div>
        <p>
          ...
          <span class="code" data-ice="name"><span><a href="class/src/loader.js~Loader.html#static-get-chunkSize">chunkSize</a></span></span><span class="code" data-ice="signature">: <span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></span></span>
        </p>
      </div>
      <div>
        
        
        <div data-ice="description"><p>Amount of program data placed in each load Transaction </p>
</div>
      </div>
    </td>
    <td>
    ...
    <td>
      <div>
        <p>
          ...
          <span class="code" data-ice="name"><span><a href="class/src/loader.js~Loader.html#static-method-getMinNumSignatures">getMinNumSignatures</a></span></span><span class="code" data-ice="signature">(dataLength: <span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></span>): <span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></span></span>
        </p>
      </div>
      <div>
        
        
        <div data-ice="description"><p>Minimum number of signatures required to load a program not including
retries</p>
</div>
      </div>
    </td>
    ...
    <td>
      <div>
        <p>
          ...
          <span class="code" data-ice="name"><span><a href="class/src/loader.js~Loader.html#static-method-load">load</a></span></span><span class="code" data-ice="signature">(connection: <span><a href="class/src/connection.js~Connection.html">Connection</a></span>, payer: <span><a href="class/src/account.js~Account.html">Account</a></span>, program: <span><a href="class/src/account.js~Account.html">Account</a></span>, programId: <span><a href="class/src/publickey.js~PublicKey.html">PublicKey</a></span>, data: <span>Buffer</span> | <span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array">Uint8Array</a></span> | <span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array">Array</a></span>&lt;<span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></span>&gt;): <span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise">Promise</a></span>&lt;<span><a href="class/src/publickey.js~PublicKey.html">PublicKey</a></span>&gt;</span>
        </p>
      </div>
      <div>
        
        
        <div data-ice="description"><p>Loads a generic program  </p>
</div>
      </div>
    </td>
    <td>
...
<div class="detail" data-ice="detail">
  <h3 data-ice="anchor" id="static-get-chunkSize">
    <span class="access" data-ice="access">public</span>
    <span data-ice="static">static</span>
    <span class="kind" data-ice="kind">get</span>
    ...
    <span class="code" data-ice="name">chunkSize</span><span class="code" data-ice="signature">: <span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></span></span>
    <span class="right-info">
      
      
      <span data-ice="source"><span><a href="file/src/loader.js.html#lineNumber22">source</a></span></span>
    </span>
  </h3>
...
<div class="detail" data-ice="detail">
  <h3 data-ice="anchor" id="static-method-getMinNumSignatures">
    <span class="access" data-ice="access">public</span>
    <span data-ice="static">static</span>
    ...
    <span class="code" data-ice="name">getMinNumSignatures</span><span class="code" data-ice="signature">(dataLength: <span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></span>): <span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></span></span>
    <span class="right-info">
      
      
      <span data-ice="source"><span><a href="file/src/loader.js.html#lineNumber37">source</a></span></span>
    </span>
  </h3>
...
<div class="detail" data-ice="detail">
  <h3 data-ice="anchor" id="static-method-load">
    <span class="access" data-ice="access">public</span>
    <span data-ice="static">static</span>
    ...
    <span class="code" data-ice="name">load</span><span class="code" data-ice="signature">(connection: <span><a href="class/src/connection.js~Connection.html">Connection</a></span>, payer: <span><a href="class/src/account.js~Account.html">Account</a></span>, program: <span><a href="class/src/account.js~Account.html">Account</a></span>, programId: <span><a href="class/src/publickey.js~PublicKey.html">PublicKey</a></span>, data: <span>Buffer</span> | <span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array">Uint8Array</a></span> | <span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array">Array</a></span>&lt;<span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></span>&gt;): <span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise">Promise</a></span>&lt;<span><a href="class/src/publickey.js~PublicKey.html">PublicKey</a></span>&gt;</span>
    <span class="right-info">
      
      
      <span data-ice="source"><span><a href="file/src/loader.js.html#lineNumber50">source</a></span></span>
    </span>
  </h3>
  ...
  <table class="params">
    ...
    <tr data-ice="property" data-depth="0">
      ...
      <td data-ice="type" class="code"><span><a href="class/src/connection.js~Connection.html">Connection</a></span></td>
      <td data-ice="appendix"></td>
      <td data-ice="description"><p>The connection to use</p>
</td>
    </tr>
<tr data-ice="property" data-depth="0">
      <td data-ice="name" class="code" data-depth="0">payer</td>
      <td data-ice="type" class="code"><span><a href="class/src/account.js~Account.html">Account</a></span></td>
      <td data-ice="appendix"></td>
      <td data-ice="description"><p>System account that pays to load the program</p>
</td>
    </tr>
<tr data-ice="property" data-depth="0">
      ...
      <td data-ice="type" class="code"><span><a href="class/src/account.js~Account.html">Account</a></span></td>
      <td data-ice="appendix"></td>
      <td data-ice="description"><p>Account to load the program into</p>
</td>
    </tr>
<tr data-ice="property" data-depth="0">
      ...
      <td data-ice="appendix"></td>
      <td data-ice="description"><p>Public key that identifies the loader</p>
</td>
    </tr>
<tr data-ice="property" data-depth="0">
      ...
      <td data-ice="appendix"></td>
      <td data-ice="description"><p>Program octets</p>
</td>
    </tr>
</tbody>
  </table>
  ...
  <div class="return-params" data-ice="returnParams">
    ...
    <table>
      <tbody>
        <tr>
          <td class="return-type code" data-ice="returnType"><span><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise">Promise</a></span>&lt;<span><a href="class/src/publickey.js~PublicKey.html">PublicKey</a></span>&gt;</td>
